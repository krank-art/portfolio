...
import { setupNsfwDecryption, setupPostDecryption } from "./decrypto";
import buildId from "virtual:build-id";

window.__KRANK_BUILD_ID__ = buildId; // We need this for cache invalidation
...
(async () => { await setupNsfwDecryption() })();
setupPostDecryption();
