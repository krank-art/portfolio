...
function generateExampleChart() {
  ...
  svg.append("g")
    ...
    .each(function (d) {
      ...
      d.getBBox = () => {
        return {
          ...
          y: d.labelOrigin.y - d.height * d.yAnchorOffset - fontSize,
          //y: d.labelOrigin.y,
          width: d.width,
          height: d.height,
        }
      ...
      d.sx = bounds.x;
      d.ox = bounds.x + bounds.width;
      d.sy = bounds.y + bounds.height * d.yAnchorOffset;
      d.oy = bounds.y + bounds.height * d.yAnchorOffset;
    })
    .attr("x", d => d.labelOrigin.x)
    .attr("text-anchor", d => d.textAlign)
    .call(text => text.append("tspan")
      .attr("x", d => d.labelOrigin.x)
      //.attr("y", d => d.getBBox().y - d.yAnchorOffset * d.getBBox().height)
    ...
    .call(text => text.append("tspan")
      .attr("x", d => d.labelOrigin.x)
      .attr("y", d => d.labelOrigin.y + (1 - d.yAnchorOffset) * d.getBBox().height - fontSize)
