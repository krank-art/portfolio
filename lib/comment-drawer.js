...
class CommentDrawer {
  constructor({ width, height, scale, container }) {
    ...
    // Scale controls
    const toolBarEditing = this.container.querySelector("[data-control-id=tools-editing]")
    const toolBarMain = this.container.querySelector("[data-control-id=tools-main]")
    toolBarEditing.classList.add("bi-scale-" + this.scale);
    toolBarMain.classList.add("bi-scale-" + this.scale);
...
export function setupCommentDrawer() {
