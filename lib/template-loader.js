...
export default class TemplateLoader {
  ...
  static async readParitalsInDir(dirPath) {
    ...
    for (const file of files) {
      ...
      if (stats.isDirectory()) {
        const subPartials = await TemplateLoader.readParitalsInDir(filePath);
...
const partials = await TemplateLoader.readParitalsInDir("./components");
