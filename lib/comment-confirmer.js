  ...
  form.innerHTML = `
      ...
      <div class="comment-confirmer-body">
        ...
        <div class="comment-confirmer-input-row inputs">
          ...
          <input class="comment-confirmer-input" type="text" name="username" placeholder="Please enter a username" required>
        </div>

        <div class="comment-confirmer-input-row inputs">
          <label for="Website">Website&nbsp;</label>
          <input class="comment-confirmer-input" type="url" name="website" placeholder="Homepage, BlueSky URL, etc.">
        </div>
