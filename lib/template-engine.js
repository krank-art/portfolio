...
export default class TemplateEngine {
   ...
   * @returns {PreparedSfc}
   */
  static async prepareSfcNew({ html, style, script, dataChunk, dataSliceName = "module" }) {
    ...
    const module = await executeModule(script, dataChunk.flatten()); // TODO: Provide context
  ...
  static async prepareSfc(input, data, defaultLayout = "default") {
    const output = {};
    ...
    const layout = module?.layout ?? defaultLayout;
